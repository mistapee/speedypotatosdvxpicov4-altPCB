updates - fixedv2 Gerber zip - basically the cut out for the pico was slightly too tight for some of the zero boards, so i've widened it slightly, the 'hopefully' gerber zip is for a test run of our top plate design, they've been ordered but not arrived yet.
